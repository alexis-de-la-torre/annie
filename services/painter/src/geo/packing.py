...
def center_rects_y(rects):
    ...
    for i, rect in enumerate(rects):
        ...
        acc.append(Rect(rect.x, y, rect.width, rect.height,
                        packed_children, rect.direction, rect.image, rect.text, rect.text_size, rect.image_ext, rect.team_id))
...
def arrange_rects_x(rects, origin_x=None, origin_y=None):
    ...
    for i, rect in enumerate(rects):
        ...
        acc.append(Rect(x, origin_y, rect.width, rect.height,
                        arranged_children, rect.direction, rect.image, rect.text, rect.text_size, rect.image_ext, rect.team_id))
